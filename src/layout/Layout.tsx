...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <header className="bg-green-900 fixed top-0 left-0 w-full p-4 text-white flex items-center justify-between">
      ...
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-green-900 text-white p-3 rounded-lg shadow-lg flex items-center justify-between space-x-4 w-[90%] max-w-3xl">
      ...
      {/* Footer */}
      <footer className="bg-green-900 p-4 text-white text-center">
